...
Algo y la función andISayHello.
...
La variable de temporizador invocada como función.
...
La función externa stopWatch ya no está activa y la variable del temporizador está vinculada a la función getDelay.
...
Un cierre definido esquemáticamente.
...
Una definición más formal de cierre.
